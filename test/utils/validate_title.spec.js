...
describe('validateTitle utility', () => {
  ...
  it('should return false for 666', () => {
    const call = function() {
      validateTitle(666);
    };
  ...
  it('should return false for strings of zero length', () => {
    const call = function() {
      validateTitle('');
    };
  ...
  it('should return false for strings of spaces', () => {
    const call = function() {
      validateTitle('      ');
    };
    assert.throws(call, 'Validation Error: Invalid "title": ');
  ...
  it('should throw exception when "title" omitted', () => {
